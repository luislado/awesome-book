...
Various international standards do exist to ensure the quality of soil data. However, they tend to focus on general principles and quality-assurance frameworks rather than the detail of describing data quality (Briggs and Searle, 2016). In addition, data standards for soil data, generally, are not open and are difficult to find (Onerhime, 2020). This limits its implementation in real cases.
