...
```{r, fig-georreference1, fig.cap = "Create Grid options", echo = FALSE}
knitr::include_graphics("images/georeference_fig1.png")
```

```{r, fig-georreference2, fig.cap = "Create Grid dialog box", echo = FALSE}
knitr::include_graphics("images/georeference_fig2.png")
```

   3) Open the `Georeferencer`.
   
```{r, fig-georreference3, fig.cap = "Georeferencer in menu", echo = FALSE}
knitr::include_graphics("images/georeference_fig3.png")
```

```{r, fig-georreference4, fig.cap = "Georeferencer box", echo = FALSE}
...
```{r, fig-georreference5, fig.cap = "Georeferencing procedure", echo = FALSE}
...
```{r, fig-georreference6, fig.cap = "Georeferencing procedure", echo = FALSE}
...
```{r, fig-georreference7, fig.cap = "Georeferenced output", echo = FALSE}
